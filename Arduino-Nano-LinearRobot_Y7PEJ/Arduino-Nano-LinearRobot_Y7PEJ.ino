...
//The different positions to use throughout
Pos currentPos;
Pos maxPos;
Pos newPos;
...
//----------------------------------------------------
    ...
    case failure:
      ...
      //Set to idle after failure update
      mainCommand = idle;
      break;
    ...
    case changeColor:
      ...
      //Set the led values retrieved from serial input
    ...
    case discoLight:
      ...
      updateStatusAndNotify(busy); // When in an opperation state is busy.
      ledDiscoShow();
      break;
