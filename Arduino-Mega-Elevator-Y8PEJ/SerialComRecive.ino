/**
  ...
  This function does the parsing and saves the parsed data. Sets the appropriate MAIN COMMAND to do the task which it recieved.
  
  If message:
  Parses the data, checks first for device address.
  If device addres is found, check which command it has recieved, and parse the attached payload if there is any.
*/
